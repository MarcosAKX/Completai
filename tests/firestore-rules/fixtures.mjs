...
export const client = (uid) => ({ uid, type: 'client', name: 'Cliente teste', email: `${uid}@example.test`, createdAt });
export const station = (uid) => ({ uid, type: 'gas_station', cnpj: '12345678000190', email: `${uid}@example.test`, brandName: 'Posto teste', createdAt, updatedAt: createdAt });
export const publicStation = (uid) => ({
  uid, brandName: 'Posto teste', address: 'Rua de teste, 100', city: 'Bebedouro',
