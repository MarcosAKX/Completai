...
(async () => {
  ...
  try {
    ...
    await setDoc(doc(db,'public_stations/audit-user'),{state:'SP',city:'Bebedouro',citySearchKey:'bebedouro',services:[],tags:[],prices:'invalid'});
    console.log('CONFIRMED: owner can publish non-map prices accepted by rules');
